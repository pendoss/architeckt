...
const startServiceA = async () => {
    ...
    const swaggerOptions = {
        definition: {
            ...
            info: {
                title: 'Service A API',
                version: '1.0.0',
                description: 'Service A API documentation',
            },
            servers: [
                {
    ...
    console.log('RabbitMQ connection established in Service A');
    ...
    process.on('SIGINT', async () => {
        console.log('Shutting down Service A...');
        await channel.close();
